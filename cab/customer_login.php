...
<head>
    ...
    <script>
    function myFunction() {
    location.replace("find_ride.php")
    }
</script>
</script>
<style type="text/css">
...
<body>
      ...
      <a class="navbar-brand" href="#"><img src="./images/lo.png"  height="42" width="42" ></a> 
        ...
        <ul>
        	<ul style="color:white; margin-left:550px; ">
        	 <?php
        	   $sql = "SELECT *  FROM customer WHERE customer_id='{$_SESSION['un']}'";
    ...
    <div style="padding-top: 100px; ">
    	<form style="" action="find_ride.php" method="POST">
        ...
        <br><br>
  		<label for="dest_loc" style="margin-left:20px; "><b>Destination Location:</b></label>
        <input type="text" style=" color: white;" placeholder="Enter Your Destination Location" name="dest_loc" required>
  		<br><br>
  		<label for="car_type" style="margin-left:20px; "><b>Choose the type of car:</b></label><br>
  		<input style="margin-left:20px; " type="radio" name="car" value="go" checked> Go
  		<input type="radio" name="car" value="premier"> Premier
  		<input type="radio" name="car" value="pool"> Pool
  		<input type="radio" name="car" value="xl"> XL
  		<br><br>


  		<button  class="button button5" style="margin-left:20px; color: white; " onclick="myFunction()" type="submit" class="">Request One Ride</button>
